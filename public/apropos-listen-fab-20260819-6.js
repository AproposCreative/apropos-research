(function () {
  ...
  function ensureCss() {
    ...
    style.textContent = [
      ...
      "box-shadow:0 10px 40px rgba(0,0,0,0.32),0 0 12px rgba(255,255,255,0.06);",
      "}",
      ...
      "background:conic-gradient(from var(--apropos-listen-a),",
      "rgba(18,18,18,0.04),rgba(18,18,18,0.28),rgba(18,18,18,0.05),",
      "rgba(18,18,18,0.18),rgba(18,18,18,0.04));",
      "}",
      "html:not(.apropos-theme-dark) #" + FAB_ID + "::after,body:not(.apropos-theme-dark) #" + FAB_ID + "::after{",
      "background:rgba(255,255,255,0.72);",
      "box-shadow:0 10px 36px rgba(0,0,0,0.12),0 0 8px rgba(255,255,255,0.2);",
      "}",
