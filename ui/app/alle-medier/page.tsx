        ...
        <div className="sticky top-4 z-40 mb-8">
          <div className="flex flex-col xl:flex-row gap-4 items-start xl:items-center">
            ...
            <div className="flex-1 xl:flex-2">
              <div className="flex items-center gap-2 bg-white/20 dark:bg-black/30 backdrop-blur-3xl rounded-3xl p-2 border border-white/20 dark:border-white/10 shadow-2xl overflow-x-auto">
                <a 
            ...
            <div className="lg:w-80 flex-shrink-0">
              <div className="bg-white/20 dark:bg-black/30 backdrop-blur-3xl rounded-3xl py-3 px-3 border border-white/20 dark:border-white/10 shadow-2xl">
