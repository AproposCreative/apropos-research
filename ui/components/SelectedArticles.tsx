...
export default function SelectedArticles({ allArticles }: { allArticles: any[] }) {
  ...
  if (count === 0) {
    return (
      <div className="text-center py-16">
        ...
        <a 
          href="/" 
          className="inline-flex items-center px-6 py-3 bg-slate-100/70 dark:bg-slate-800/70 backdrop-blur-sm text-slate-700 dark:text-slate-300 rounded-xl text-sm font-medium hover:bg-slate-200/70 dark:hover:bg-slate-700/70 transition-all duration-300 border border-slate-300/50 dark:border-slate-600/50 shadow-lg ring-1 ring-white/20 dark:ring-slate-700/50"
        >
          Gå til forsiden
        </a>
      </div>
  ...
  return (
    <div className="space-y-6">
      {/* Header med actions */}
      <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-2xl border border-slate-200/50 dark:border-slate-700/50 rounded-2xl p-6 shadow-lg ring-1 ring-white/20 dark:ring-slate-700/50">
