...
type MiniMenuProps = {
  ...
  onSearch: () => void;
  onToggleReview: () => void;
  onToggleWebApps: () => void;
  onToggleShelf: () => void;
  onNewArticle: () => void;
  onToggleSources: () => void;
  onOpenPromptArchitect: () => void;
  onToggleSettings: () => void;
  /** False når Nyhedsbrev, AI-posting el.l. er aktiv — skjuler chat-specifikke genveje (review, kladder, …). */
  writerShortcutsEnabled?: boolean;
  /** Vises når writerShortcutsEnabled er false; åbner AI Writer-chatten. */
  onGoToAiWriter?: () => void;
};
