...
const SearchCardItem = memo(function SearchCardItem({ 
  ...
  if (compact) {
    return (
      <article 
        className="bg-white/70 dark:bg-black/70 backdrop-blur-xl rounded-xl border border-white/40 dark:border-white/20 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer"
        onClick={handleClick}
      >
  ...
  return (
    <article 
      className="bg-white/70 dark:bg-black/70 backdrop-blur-xl rounded-2xl border border-white/40 dark:border-white/20 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer overflow-hidden"
      onClick={handleClick}
    >
      {/* Image */}
