...
export default function AIDrafts() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default: return 'text-slate-600 dark:text-slate-400 bg-slate-100/70 dark:bg-black/70';
    }
  };
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-lg">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="px-4 py-2 bg-slate-100/70 dark:bg-black/70 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200/70 dark:hover:bg-slate-700/70 transition-colors duration-300 border border-slate-300/50 dark:border-slate-600/50">
              Eksporter alle
            </button>
            {drafts.length > 0 && (
              <button 
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-slate-800 dark:text-black-100 mb-2">
                  {draft.title}
                </h3>
                <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-black-400">
                  <span>Baseret på: {draft.originalTitle}</span>
                  <span>•</span>
                  <span className="px-2 py-1 bg-slate-100/70 dark:bg-pure-black/70 text-slate-600 dark:text-black-400 rounded-full border border-slate-300/50 dark:border-black-700/50">
                    {draft.source}
                  </span>
                  <span>•</span>
              ...
              <div className="text-right text-sm text-slate-500 dark:text-black-500">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-50/70 dark:bg-pure-black/50 rounded-xl p-4 border border-slate-200/50 dark:border-slate-700/50">
