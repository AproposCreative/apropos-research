...
import { publishArticleItemForLocale } from '@/lib/webflow/locale-items';
  ...
  for (const delay of [0, 500, 1500, 3000]) {
    ...
    try {
      ...
      if (live.id !== input.itemId || live.cmsLocaleId !== localeId || live.isDraft !== false || live.isArchived === true ||
          ...
          cmsFieldHash(object(live.fieldData)) !== cmsFieldHash(fields)) throw new Error('liv_publication_live_mismatch');
